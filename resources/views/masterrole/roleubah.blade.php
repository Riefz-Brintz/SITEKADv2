                            ...
                            <div class="row"> 
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input id="nama_role" type="text" class="form-control form-control-sm{{ $errors->has('nama_role') ? ' is-invalid' : '' }}" name="nama_role" value="{{ $item->nama_role }}" required autofocus>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input id="keterangan" type="text" class="form-control form-control-sm{{ $errors->has('keterangan') ? ' is-invalid' : '' }}" name="keterangan" value="{{ $item->keterangan }}" required autofocus>
                        ...
                        <div class="card text-center mb">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-role" role="tabpanel" aria-labelledby="pills-role-tab">
                                    @include('masterRole.roleubah_menu')
                                </div>
                            </div>
