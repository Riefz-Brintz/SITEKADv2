...
{{-- ===================================================================================================================================== --}}
    ...
    <!-- jquery
		============================================ -->
    <script scr="{{ asset('template/js/vendor/jquery-1.12.4.min.js')}}"></script>
    <!-- bootstrap JS
		============================================ -->
    <script scr="{{ asset('template/js/bootstrap.min.js')}}"></script>
    <!-- wow JS
		============================================ -->
    <script scr="{{ asset('template/js/wow.min.js')}}"></script>
    <!-- price-slider JS
		============================================ -->
    <script scr="{{ asset('template/js/jquery-price-slider.js')}}"></script>
    <!-- meanmenu JS
		============================================ -->
    <script scr="{{ asset('template/js/jquery.meanmenu.js')}}"></script>
    <!-- owl.carousel JS
		============================================ -->
    <script scr="{{ asset('template/js/owl.carousel.min.js')}}"></script>
    <!-- sticky JS
		============================================ -->
    <script scr="{{ asset('template/js/jquery.sticky.js')}}"></script>
    <!-- scrollUp JS
		============================================ -->
    <script scr="{{ asset('template/js/jquery.scrollUp.min.js')}}"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script scr="{{ asset('template/js/scrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
    <script scr="{{ asset('template/js/scrollbar/mCustomScrollbar-active.js')}}"></script>
    <!-- metisMenu JS
		============================================ -->
    <script scr="{{ asset('template/js/metisMenu/metisMenu.min.js')}}"></script>
    <script scr="{{ asset('template/js/metisMenu/metisMenu-active.js')}}"></script>
    <!-- data table JS
		============================================ -->
    <script scr="{{ asset('template/js/data-table/bootstrap-table.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/tableExport.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/data-table-active.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/bootstrap-table-editable.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/bootstrap-editable.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/bootstrap-table-resizable.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/colResizable-1.5.source.js')}}"></script>
    <script scr="{{ asset('template/js/data-table/bootstrap-table-export.js')}}"></script>
    <!--  editable JS
		============================================ -->
    <script scr="{{ asset('template/js/editable/jquery.mockjax.js')}}"></script>
    <script scr="{{ asset('template/js/editable/mock-active.js')}}"></script>
    <script scr="{{ asset('template/js/editable/select2.js')}}"></script>
    <script scr="{{ asset('template/js/editable/moment.min.js')}}"></script>
    <script scr="{{ asset('template/js/editable/bootstrap-datetimepicker.js')}}"></script>
    <script scr="{{ asset('template/js/editable/bootstrap-editable.js')}}"></script>
    <script scr="{{ asset('template/js/editable/xediable-active.js')}}"></script>
    <!-- Chart JS
		============================================ -->
    <script scr="{{ asset('template/js/chart/jquery.peity.min.js')}}"></script>
    <script scr="{{ asset('template/js/peity/peity-active.js')}}"></script>
    <!-- tab JS
		============================================ -->
    <script scr="{{ asset('template/js/tab.js')}}"></script>
    <!-- plugins JS
		============================================ -->
    <script scr="{{ asset('template/js/plugins.js')}}"></script>
    <!-- main JS
		============================================ -->
    <script scr="{{ asset('template/js/main.js')}}"></script>
    <!-- tawk chat JS
		============================================ -->
    <script scr="{{ asset('template/js/tawk-chat.js')}}"></script>
</body>
