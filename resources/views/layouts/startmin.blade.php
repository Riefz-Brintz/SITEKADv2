        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">SITEKAD</a>
                </div>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="{{ route('Tad') }}"><i class="fa fa-edit fa-fw"></i> Forms</a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a class="active" href="blank.html">Blank Page<span class="fa arrow"></span></a>

                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="blank.html">test1</a>
                                            </li>
                                            <li>
                                                <a href="login.html">test2</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                       {{--  <div class="col-lg-12">
                            <h1 class="page-header">Welcome to SITEKAD</h1>
